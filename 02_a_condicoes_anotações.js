...
let nomef (lado1 == lado2 !== base && lado1 == base !== lado2 && base == lado1 !==lado2)
idade = 18
nome = "Bob"
if (idade > 13)
...
if (frequencia >= 75 && nota_final >= 7) {
    console.log("Você foi aprovado!")f (lado1 == lado2 !== base && lado1 == base !== lado2 && base == lado1 !==lado2)
frequencia = 75
nota_final = 9.5
